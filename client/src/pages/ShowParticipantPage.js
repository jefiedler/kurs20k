...
import ContentShowParticipant from "../component/Content/Participant/Show";

function ShowParticipantPage({ link, title, user, imgPath, imgTitle }) {
  return (
    <Container>
      <HeaderContainer>
        <MainHeader
